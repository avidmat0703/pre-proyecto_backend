...
INSERT INTO libro (titulo, descripcion, imagen_url, isbn, autor_id) VALUES
                                                            ('Cien años de soledad', 'La obra más famosa de García Márquez, que narra la historia de la familia Buendía.', 'a', '978-0060883287', 1),
                                                            ('Harry Potter y la piedra filosofal', 'El primer libro de la serie de Harry Potter, que introduce al joven mago.', 'b','978-0747532699', 2),
                                                            ('1984', 'Una novela distópica de Orwell sobre un futuro totalitario.', 'c','978-0451524935', 3),
                                                            ('Orgullo y prejuicio', 'Un clásico de Jane Austen que explora las relaciones y las diferencias sociales.', 'd','978-0141439518', 4),
                                                            ('Guerra y paz', 'La famosa novela de Tolstoy que cubre la invasión napoleónica en Rusia.', 'e','978-0143039990', 5),
                                                            ('La metamorfosis', 'Una obra de Kafka que examina la alienación y el absurdo.', 'f','978-0140446285', 6),
                                                            ('Norwegian Wood', 'Una novela de Murakami que explora el amor, la pérdida y la juventud.', 'g','978-0375704024', 7),
                                                            ('Las aventuras de Tom Sawyer', 'Las aventuras de un joven travieso en el río Mississippi.', 'h','978-0486295372', 8),
                                                            ('Asesinato en el Orient Express', 'Una de las más famosas novelas de Agatha Christie con el detective Hercule Poirot.', 'i','978-0062073501', 9),
                                                            ('El viejo y el mar', 'Una historia sobre la lucha entre un hombre y un pez gigante, escrita por Hemingway.', 'j','978-0684801223', 10),
                                                            ('Frida Kahlo: Sus vidas', 'Un vistazo a la vida y el arte de la famosa pintora mexicana.', 'j','978-0061120253', 11),
                                                            ('Fundación', 'Una obra maestra de la ciencia ficción de Isaac Asimov.', 'k','978-0553382570', 12),
                                                            ('El león, la bruja y el armario', 'El primer libro de las Crónicas de Narnia, escrito por C.S. Lewis.', 'l','978-0064404990', 13),
                                                            ('La ciudad y los perros', 'Una novela que narra la vida de un grupo de cadetes militares en Lima.', 'm','978-8437603737', 14),
                                                            ('Cuento de Navidad', 'Una de las más famosas historias de Dickens, que trata sobre la redención.', 'o','978-0141192589', 15),
                                                            ('El gran Gatsby', 'La historia de un amor no correspondido en la América de los años 20.', 'p','978-0743273565', 16),
                                                            ('Mrs Dalloway', 'Una novela de Virginia Woolf que se desarrolla en un solo día.', 'q','978-0156628709', 17),
                                                            ('El Hobbit', 'El primer libro de Tolkien en la Tierra Media, precuela de El Señor de los Anillos.', 'r','978-0547928227', 18),
                                                            ('La campana de cristal', 'Una novela semi-autobiográfica de Sylvia Plath.', 's','978-0060837029', 19),
                                                            ('Anna Karenina', 'Una obra maestra de Tolstoy sobre amor, obsesión y tragedia.', 't','978-0375756191', 20),
                                                            ('Matadero cinco', 'Una novela anti-bélica y filosófica de Kurt Vonnegut.', 'u','978-0385333849', 21),
                                                            ('El color de la magia', 'La primera novela de la serie Mundodisco de Terry Pratchett.', 'v','978-0062225747', 22),
                                                            ('Carrie', 'Una novela de terror psicológico escrita por Stephen King.', 'w','978-0307743664', 23),
                                                            ('La divina comedia', 'El poema épico de Dante sobre el viaje de un alma por el infierno, el purgatorio y el paraíso.', 'x','978-0140448952', 24),
                                                            ('En busca del tiempo perdido', 'La obra monumental de Marcel Proust sobre la memoria y el tiempo.', 'y','978-0141180315', 25),
                                                            ('American Gods', 'Una novela de Neil Gaiman que mezcla mitología y lo moderno.', 'z','978-0380789030', 26),
                                                            ('La color púrpura', 'Una novela de Alice Walker sobre las dificultades de una mujer afroamericana en el sur de los EE.UU.', 'aa','978-0156028356', 27),
                                                            ('El guardián entre el centeno', 'La famosa novela de Salinger sobre la adolescencia y la alienación.', 'ab','978-0316769488', 28),
                                                            ('Beloved', 'Una novela de Toni Morrison sobre la esclavitud y la libertad.', 'ac','978-1400033416', 29),
                                                            ('El retrato de Dorian Gray', 'Una novela de Oscar Wilde sobre la belleza, la moral y la decadencia.', 'ad','978-0141439570', 30);
